...
public class MostrarDetalles3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabase.child("Sensores3").child("Fecha y Hora").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
        ...
        mDatabase.child("Sensores3").child("Observacion").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
        ...
        mDatabase.child("Sensores3").child("Tipo de Sensor").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
        ...
        mDatabase.child("Sensores3").child("Ubicacion del sensor").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
    ...
    public void guardarObservacion(View view){
        ...
        mDatabase.child("Sensores3").updateChildren(newObservacion).addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
            public void onSuccess(Void unused) {
                Toast.makeText(MostrarDetalles3.this,"Se ha actualizado la observacion!",Toast.LENGTH_SHORT).show();
            }
        });
    }
