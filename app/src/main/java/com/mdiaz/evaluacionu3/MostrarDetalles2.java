...
public class MostrarDetalles2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabase.child("Sensores2").child("Fecha y Hora").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
        ...
        mDatabase.child("Sensores2").child("Observacion").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
        ...
        mDatabase.child("Sensores2").child("Tipo de Sensor").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
        ...
        mDatabase.child("Sensores2").child("Ubicacion del sensor").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
    ...
    public void guardarObservacion(View view){
        ...
        mDatabase.child("Sensores2").updateChildren(newObservacion).addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
            public void onSuccess(Void unused) {
                Toast.makeText(MostrarDetalles2.this,"Se ha actualizado la observacion!",Toast.LENGTH_SHORT).show();
            }
        });
    }
